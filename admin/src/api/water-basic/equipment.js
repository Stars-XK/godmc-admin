...
export function importStationBatch(data) { return request({ url: '/water-basic/station/importBatch', method: 'post', data: data, timeout: 600000 }) }
...
export function importDeviceBatch(data) { return request({ url: '/water-basic/device/importBatch', method: 'post', data: data, timeout: 600000 }) }
